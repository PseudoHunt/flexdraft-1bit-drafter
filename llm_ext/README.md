...
Continuing on a fresh machine: the repo-root [`CLAUDE.md`](../CLAUDE.md) is the handoff (state, queue, setup, gotchas);
`llm_ext/tools/` holds the live-table and write-up scripts.
