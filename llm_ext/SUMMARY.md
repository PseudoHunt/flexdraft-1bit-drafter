...
and block 3 PPL 15.25 / 14.99 (uniform 16.1–20.7) at 128 samples — where only 4× more data had reached before. Full model (two runs, NanoQuant 8/8/8 at 128 samples): 30.89 / 31.46 pre-KD / **27.01 / 27.27 post-KD**. It also suggests the covariance objective was handicapped by stale Σ.
